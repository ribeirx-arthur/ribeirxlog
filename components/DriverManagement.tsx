                                ...
                                <div className="flex items-center gap-3">
                                    {driver.hasAppAccess ? (
                                        <>
                                            ...
                                            <button
                                                onClick={() => revokeAccess(driver)}
                                                className="px-4 py-2.5 bg-rose-500/10 border border-rose-500/20 rounded-xl text-rose-400 hover:bg-rose-500/20 transition-all text-sm font-bold"
                                            >
                                                Revogar
                                            </button>
                                        </>
