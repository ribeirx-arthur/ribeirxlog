...
const NewTrip: React.FC<NewTripProps> = ({ vehicles, drivers, shippers, onSave, profile }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          ...
          <button 
            onClick={handleSave}
            className="w-full py-7 bg-emerald-500 hover:bg-emerald-600 text-emerald-950 font-black rounded-[2rem] shadow-2xl shadow-emerald-500/20 transition-all flex items-center justify-center gap-4 text-xl uppercase tracking-[0.1em]"
          >
        ...
        <div className="lg:col-span-4 space-y-6">
           <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 sticky top-24 shadow-2xl relative overflow-hidden group">
